  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Route::is('abris') ? 'active' : '' }}" href="/abris">Abris</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Route::is('guides') ? 'active' : '' }}" href="/guides">Guides</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Route::is('sommets') ? 'active' : '' }}" href="/sommets">Sommets</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Route::is('vallees') ? 'active' : '' }}" href="/vallees">Vallées</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Route::is('ascension') ? 'active' : '' }}" href="/ascension">Ascensions</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Route::is('randonnees') ? 'active' : '' }}" href="/randonnees">Randonnées</a>
        </li>
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown me-4">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="bi bi-person-fill {{ Auth::check() ? 'text-success' : 'text-danger' }}"></i>
            @auth
              {{ Auth::user()->name }}
            @else
              Utilisateur
