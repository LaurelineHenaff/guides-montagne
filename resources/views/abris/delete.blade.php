<x-layout>
    ...
    <div class="alert alert-warning">
      <i class="bi bi-exclamation-triangle-fill me-3"></i>Vous êtes sur le point de supprimer l'abri : <strong>{{$abri->nom_Abris}}</strong> !
    </div>
    ...
    <form action="/abris/{{ $abri->code_Abris }}" method="POST" class="mt-5">
      @csrf
      @method('delete')
  
      <button type="submit" class="btn btn-danger me-2">Confirmer</button>
      <a href="/abris" class="btn btn-secondary">Annuler</a>
    </form>
