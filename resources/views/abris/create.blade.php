<x-layout>
  ...
  <form action="/abris" method="POST" class="mb-4 bg-light p-4 rounded-2 border mx-auto" style="max-width: 28rem;">
    <h1 class="mb-4 fs-3">Ajouter un Abri</h1>
    @csrf
    ...
    <div class="row">
      ...
      <div class="col-7">
        ...
        <input id="nom_Abris" class="form-control form-control-sm mb-1" type="text" name="nom_Abris" value="{{ old('nom_Abris') }}">
        @error('nom_Abris')
      ...
      <div class="col-5">
        ...
        <select id="type_Abris" class="form-select form-select-sm mb-1" name="type_Abris">
          ...
          <option value="refuge" @php echo old('type_Abris') === 'refuge' ? 'selected' : ''; @endphp>
            Refuge
          </option>
        </select>
        @error('type_Abris')
    ...
    <div class="row mt-2">
      <div class="col">
        ...
        <select id="code_Vallees" class="form-select form-select-sm mb-1" name="code_Vallees">
          ...
          @php
            $selected = intval(old('code_Vallees')) === $vallee->code_Vallees ? 'selected' : '';
          @endphp
    ...
    <div class="row mt-2">
      <div class="col">
        ...
        <input id="altitude_Abris" class="form-control form-control-sm mb-1" type="number" name="altitude_Abris" value="{{ old('altitude_Abris') }}">
      ...
      <div class="col">
        ...
        <input id="places_Abris" class="form-control form-control-sm mb-1" type="number" min="0" name="places_Abris" value="{{ old('places_Abris') }}">
        @error('places_Abris')
          <p class="text-danger small mt-1 mb-0">{{ $message }}</p>
        @enderror
      </div>
      <div class="col">
        ...
        <input id="prixNuit_Abris" class="form-control form-control-sm mb-1" type="text" name="prixNuit_Abris" value="{{ old('prixNuit_Abris') }}">
    ...
    <div id="info-type_Abris" class="row mt-2">
      ...
      <div class="col">
        ...
        <input id="telGardien_Abris" class="form-control form-control-sm mb-1" type="text" name="telGardien_Abris" value="{{ old('telGardien_Abris') }}">
